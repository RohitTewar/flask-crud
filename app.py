...
def deleteStudents(id):
    print(id) # Print the ID of the student to be deleted
    student = Student.query.get_or_404(id) # Query the student by ID
    print(student) # Print the student object to console
    db.session.delete(student)
    db.session.commit() # Delete the student from the database
    print("Deleted") # Print confirmation of deletion
    return redirect('/')
